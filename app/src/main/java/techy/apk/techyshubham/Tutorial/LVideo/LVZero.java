...
public class LVZero extends AppCompatActivity {
    private WebView web1;
    ProgressBar progressBar;
    private FirebaseDatabase firebaseDatabase= FirebaseDatabase.getInstance();
    private DatabaseReference reference= firebaseDatabase.getReference();
    private DatabaseReference childreference= FirebaseDatabase.getInstance().getReference().child("LVZero");
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_lvzero);
        progressBar=findViewById(R.id.loading);
        web1= (WebView) findViewById(R.id.yt);
        web1.getSettings().setJavaScriptEnabled(true);
        web1.setWebChromeClient(new WebChromeClient());
        web1.setWebChromeClient(new LVZero.MyChrome());
    }
